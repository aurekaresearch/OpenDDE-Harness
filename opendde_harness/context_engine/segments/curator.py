...
from opendde_harness.config.opendde_harness import ContextConfig
from opendde_harness.context_engine.base import AssemblyContext, Segment
from opendde_harness.context_engine.curator import (
...
class CuratorSegmentBuilder:
    ...
    def _system_prompt() -> str:
        return """You are OpenDDE Harness Curator, an internal context manager.
