...
The "local" pool covers everything that lives as a SKILL.md file on disk:
  ...
  - workspace/skills/memory/ (extracted by the memory service, optional)
...
BM25 + tokenization come from :mod:`opendde_harness.utils.bm25` (a self-contained
...
from opendde_harness.utils.bm25 import BM25Okapi as _BM25Okapi
from opendde_harness.utils.bm25 import tokenize as _tokenize
