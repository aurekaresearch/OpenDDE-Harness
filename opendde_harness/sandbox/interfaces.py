...
Import from here, or from opendde_harness.sandbox.
...
class SandboxInitError(RuntimeError):
    ...
    Defined here so mcp.py and the agent loop can import it for error
    handling without importing a concrete executor.
    """
...
class SandboxExecutor(ABC):
    ...
    Implemented by DirectExecutor (host process). ExecTool holds this
    interface and is unaware of the concrete backend.
    """
