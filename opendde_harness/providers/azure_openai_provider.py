    ...
    def _parse_response(self, response: dict[str, Any]) -> LLMResponse:
        ...
        try:
            ...
            if response.get("usage"):
                ...
                # Azure reports its prompt cache here. Dropped, a deployment
                # serving mostly cached prompts reported the full price.
                cached = int((usage_data.get("prompt_tokens_details") or {}).get("cached_tokens", 0) or 0)
                if cached:
