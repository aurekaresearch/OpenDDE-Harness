...
- **Short-circuit halts the chain.** The first hook in a phase that
  ...
  hooks in that phase are NOT called. This matters in the
  ``before_user_inbound`` phase, where a decision_consumer hook claims
  a reply that later hooks must not also process.
